  ...
  return (
    <ul className="timeline w-full">
      ...
      <li>
        ...
        <div className="timeline-end timeline-box">
          Software Dev @ Niyel Technologies
        </div>
        <hr />
      </li>
      <li>
      ...
      <li>
        ...
        <div className="timeline-end timeline-box">
          Student Assistant @ HPI <br />
          Morphou Software Co-Founder 💼
        </div>
        <hr />
      </li>
      <li>
        ...
        <div className="timeline-end timeline-box">🤷‍♂️</div>
      </li>
    </ul>
  );
}
